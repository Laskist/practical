...
class Matrix:
    ...
    >>> Matrix.__new__(cls=Matrix, matrix_1 = [[1, 2, 6], [3, 4, 5]], matrix_2 = [[1, 3, 5], [3, 5, 7]]).comparison()
    'Матрицы не равны'
    >>> Matrix.__new__(cls=Matrix, matrix_1 = [[1, 2, 6], [3, 4, 5]], matrix_2 = [[1, 2, 6], [3, 4, 5]]).comparison()
    'Матрицы равны'
    >>> Matrix.__new__(cls=Matrix, matrix_1 = [[1, 2, 6], [3, 4, 5]], matrix_2 = [[1, 3, 5], [3, 5, 7]]).sum_matrix()
    [[2, 5, 11], [6, 9, 12]]
    >>> Matrix.__new__(cls=Matrix, matrix_1 = [[1, 2, 6], [3, 4, 5], [1, 2, 6]], matrix_2 = [[1, 2, 6], [3, 4, 5]]).sum_matrix()
    'Складывать матрицы разного размера нельзя'
    >>> Matrix.__new__(cls=Matrix, matrix_1 = [[1, 2, 6], [3, 4, 5]], matrix_2 = [[1, 3, 5], [3, 5, 7]]).subtracting_matrix()
    [[0, -1, 1], [0, -1, -2]]
    >>> Matrix.__new__(cls=Matrix, matrix_1 = [[1, 2, 6], [3, 4, 5], [1, 2, 6]], matrix_2 = [[1, 2, 6], [3, 4, 5]]).subtracting_matrix()
    'Вычитать матрицы разного размера нельзя'
    """
